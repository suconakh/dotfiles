...
-- beautiful.init("~/.config/awesome/awesome-copycats/themes/dremora/theme.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key(
        ...
        {description = "screenshot", grop = "launcher"}
    ),
    awful.key(
        {modkey, "Shift"}, "r",
        awesome.restart,
